    ...
    formE1.addEventListener('submit',  event => {
        ...
        */
        ...
        if (data.username == '' || data.password == '') {
            ...
            document.getElementById('resultado').textContent='Debe ingresar usuario y contraseña';
            return;
        }
        ...
        if (data.termscondition != 'on') {
            ...
            document.getElementById('resultado').style.color="RED";
            document.getElementById('resultado').style.textAlign = "center";
            document.getElementById('resultado').textContent='Debe aceptar los Términos y condiciones del sistema';
            return;
        }
